...
class PoseSampler:
    ...
    def fly_drone(self, gate_index, time_or_speed, algorithm, angle_start):
        ...
        self.trajSelect[0] = self.MP_methods[algorithm]
        self.trajSelect[1] = 2
            ...
            with torch.no_grad():   
                ...
                if self.curr_idx >= 11:
                    ...
                    if time_or_speed == 0:
                        ...
                        print "\nVelocity based trajectory, V_avg: {0:.3}, T: {1:.3}".format(self.v_average, newTraj.t_wps[1])
        ...
        for gate_index in range(len(self.track)):
            ...
            for algorithm in MP_list:
                for k in range(N_iter): 
                    ...
                    self.fly_drone(gate_index, time_or_speed, algorithm, angle_start)
